    ...
    steps: [
      {
        element: ".home-link",
        intro:
          "Welcome to Artaholic! On this website, read all about us on the '<b>Home</b>' page",
        position: "right",
      },
      {
        element: ".gallery-link",
        intro:
          "Click on '<b>Gallery</b>' to view all of the lovely art pieces that we have for sale",
      },
      {
        element: ".sell-link",
        intro:
          "To sell your own art, click on '<b>Sell</b>' to access the '<b>Add new item</b>' form",
      },
      {
        element: ".cart-link",
        intro:
          "To view your cart and/or checkout with your purchases, click on the <b>cart icon</b>",
      },
      {
        element: ".logout-link",
      ...
      },
      {
        element: ".home-link",
        intro:
          '<iframe src="https://giphy.com/embed/1qhzTMk8mQzY0Bg7wg"</iframe>',
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <Nav.Link className="gallery-link" href="/arts">
                Gallery
              </Nav.Link>
              {AuthService.checkToken() && (
                <Nav.Link className="sell-link" href="/sell">
                  Sell
                </Nav.Link>
              )}
              {!AuthService.checkToken() && (
