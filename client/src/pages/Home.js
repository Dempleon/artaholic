    ...
    <section className="d-flex flex-wrap homepage" style={styles.homepage}>
      <div className="col-12 col-md-7 our-mission-values">
        ...
        <p style={styles.ourMissionValues.pElement}>
          ...
          welcoming, and knowledgeable in all areas of art supplies. We proudly
          work with local artists and arts organizations across the country and
          support a variety of national events as well as local community
          events.
        </p>
      </div>
      <div
        className="col-12 col-md-5 px-3 text-center homepage-image"
